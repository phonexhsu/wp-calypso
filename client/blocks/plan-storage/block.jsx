...
class PlanStorageBlock extends Component {
	static propTypes = {
	...
	getPlanTranslation() {
		...
		if ( sitePlanName === 'Premium' ) {
			return translate( 'Premium Plan', { context: 'Short plan name on storage block' } );
		} else if ( sitePlanName === 'Free' ) {
			return translate( 'Free Plan', { context: 'Short plan name on storage block' } );
		}
	...
	render() {
		...
		const classes = classNames( className, 'plan-storage__block', {
...
export default localize( PlanStorageBlock );
